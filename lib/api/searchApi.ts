...
export class SearchApi {
     ...
     */
    public async searchJsonGet (inlineObject13?: InlineObject13, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse20024;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InlineResponse20024;  }>((resolve, reject) => {
