...
export class InlineResponse2006BasicGroup {
    'id': number;
    'automatic'?: boolean;
    'name'?: string;
    'userCount'?: number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "automaticMembershipRetroactive",
            "baseName": "automatic_membership_retroactive",
            "type": "boolean"
        },
        {
            "name": "primaryGroup",
        ...
        {
            "name": "membershipVisibilityLevel",
    ...
    static getAttributeTypeMap() {
        return InlineResponse2006BasicGroup.attributeTypeMap;
    }
}
