    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<InlineResponse20014Notifications>"
        },
        {
            "name": "totalRowsNotifications",
            "baseName": "total_rows_notifications",
            "type": "number"
        },
        {
            "name": "seenNotificationId",
            "baseName": "seen_notification_id",
            "type": "number"
        },
        {
            "name": "loadMoreNotifications",
            "baseName": "load_more_notifications",
            "type": "string"
        }    ];
